    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            if len(prec)>0:
                ...
                ap_dictionary[class_name] = {'AP':ap, 'F1':F1[score_threhold_idx], 'Recall':rec[score_threhold_idx]*100, 'Precision':prec[score_threhold_idx]*100}
            else:
                print(text + "\t||\tscore_threhold=" + str(score_threhold) + " : " + "F1=0.00% ; Recall=0.00% ; Precision=0.00%")
                ap_dictionary[class_name] = {'AP':ap, 'F1':0.00, 'Recall':0.00, 'Precision':0.00}
