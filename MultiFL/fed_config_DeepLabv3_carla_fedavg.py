...
WIDTH=960 #Mapillary or CamVid, carla
HEIGHT=720 #Mapillary or CamVid, carla
...
semSeg = {
        'Edge0' : #Northern Germany
        {
            ...
            'Agent0' :
            {
                ...
                'dataset' : '/home/wbkou/AAAI/HFL-DynaCoeffi/datasets/Carla/town01_red_12/',
                'lr': 0.0001,
                'batch_size': 8,
                'betas': (0.9, 0.999),
                'weight_decay': 1e-4,
            ...
            'Agent1' :
            {
                ...
                'dataset' : '/home/wbkou/AAAI/HFL-DynaCoeffi/datasets/Carla/town02_red_12/',
                'lr': 0.0001,
                'batch_size': 8,
                'betas': (0.9, 0.999),
                'weight_decay': 1e-4,
        ...
        'GPU_ID': 0,
        'enable_optim': False,
        'FedAlgo': 'FedAvg', #Alternatives: FedAvg, FedProx-0.01, FedDyn-0.01, FedProx-0.005, FedDyn-0.005, FedStats, FedCurv-1.0, MOON, SCAFFOLD
